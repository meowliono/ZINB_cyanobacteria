...
generated quantities {
  ...
  for (n in 1:N){
    if(y[n]==0)
      log_lik[n]=log_sum_exp(bernoulli_lpmf(1|theta[n]), bernoulli_lpmf(0|theta[n])+neg_binomial_2_log_lpmf(0|mu[n],phi));
    else
      log_lik[n]=bernoulli_lpmf(0|theta[n])+neg_binomial_2_log_lpmf(y[n]|mu[n], phi);
    }
  }
